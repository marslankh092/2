...
public abstract class VideoList {
    ...
    class VideoListAdapter extends RecyclerView.Adapter<VideoListAdapter.VideoItem> {
        ...
        public VideoItem onCreateViewHolder( ViewGroup parent, int viewType) {
            ...
            return (new VideoItem(inflater.inflate(R.layout.videos_found_item_indratech, parent,
                    false)));
        }
        ...
        class VideoItem extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            VideoItem(View itemView) {
                super(itemView);
                size = itemView.findViewById(R.id.indratech_videoFoundSize);
                name = itemView.findViewById(R.id.indratech_videoFoundName);
                play = itemView.findViewById(R.id.indratech_videoFoundPlay);
                play.setOnClickListener(this);
                download = itemView.findViewById(R.id.indratech_videoFoundDownload);
                download.setOnClickListener(this);
                rename = itemView.findViewById(R.id.indratech_videoFoundRename);
            ...
            public void onClick(View v) {
                if (v == itemView.findViewById(R.id.indratech_videoFoundRename)) {
