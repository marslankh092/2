package com.toto.downloader.custom_video_view;
...
public class CustomMediaController extends FrameLayout {
    ...
    private void init(Context context) {
        ...
        View viewRoot = inflater.inflate(R.layout.custom_player_controller_indratech, this);
    ...
    private void initControllerView(View v) {
        mTitleLayout = v.findViewById(R.id.indratech_title_part);
        mControlLayout = v.findViewById(R.id.indratech_control_layout);
        loadingLayout = (ViewGroup) v.findViewById(R.id.loading_layout);
        errorLayout = (ViewGroup) v.findViewById(R.id.error_layout);
        mTurnButton = (ImageButton) v.findViewById(R.id.indratech_turn_button);
        mScaleButton = (ImageButton) v.findViewById(R.id.indratech_scale_button);
        mCenterPlayButton = v.findViewById(R.id.indratech_center_play_btn);
        ...
        mCurrentTime = (TextView) v.findViewById(R.id.indratech_has_played);
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case SHOW_COMPLETE: //7
                    showCenterView(R.id.indratech_center_play_btn);
                    break;
                case SHOW_ERROR: //5
                    show();
    ...
    private void showCenterView(int resId) {
        ...
        } else if (resId == R.id.indratech_center_play_btn) {
            if (mCenterPlayButton.getVisibility() != VISIBLE) {
