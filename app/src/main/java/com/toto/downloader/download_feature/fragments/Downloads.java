...
public class Downloads extends VDFragment implements MainActivity.OnBackPressedListener, Tracking, DownloadsInProgress.OnNumDownloadsInProgressChangeListener, DownloadsCompleted.OnNumDownloadsCompletedChangeListener {
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container,
        ...
        if (view == null) {
            ...
            pager = view.findViewById(R.id.indratech_downloadsPager);
            pager.setAdapter(new PagerAdapter());


            LinearLayout tabs0 = view.findViewById(R.id.indratech_downloadsTabs);
    ...
    class Tracking implements Runnable {
        ...
        public void run() {
            ...
            if (downloadSpeedValue > 0) {
                ...
                remaining.setText(R.string.remaining_undefine_indratech);
            }
    ...
    public void stopTracking() {
        ...
        getActivity().runOnUiThread(new Runnable() {
            @Override
            public void run() {
                downloadSpeed.setText(R.string.speed_0_indratech);
                remaining.setText(R.string.remaining_undefine_indratech);
