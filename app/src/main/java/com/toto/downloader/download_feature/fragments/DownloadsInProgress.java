...
import com.toto.downloader.utils.PermissionRequestCodes;
import com.toto.downloader.R;
import com.toto.downloader.VDFragment;
import com.toto.downloader.download_feature.DownloadManager;
import com.toto.downloader.download_feature.DownloadPermissionHandler;
import com.toto.downloader.download_feature.DownloadVideo;
import com.toto.downloader.download_feature.OnDownloadWithNewLinkListener;
import com.toto.downloader.download_feature.Tracking;
import com.toto.downloader.download_feature.lists.DownloadQueues;
...
public class DownloadsInProgress extends VDFragment implements DownloadManager.OnDownloadFinishedListener, DownloadManager.OnLinkNotFoundListener, OnDownloadWithNewLinkListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.downloads_in_progress_indratech, container, false);
...
//        DownloadManager.stopThread();
    ...
    public class DownloadListAdapter extends RecyclerView.Adapter<DownloadItem> {
        ...
        public DownloadItem onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            return new DownloadItem(inflater.inflate(R.layout.downloads_in_progress_item_indratech, parent, false));
        }
    ...
    public class DownloadItem extends RecyclerView.ViewHolder implements ViewTreeObserver
        ...
        DownloadItem(final View itemView) {
            super(itemView);
            name = itemView.findViewById(R.id.indratech_downloadVideoName);
            progress = itemView.findViewById(R.id.indratech_downloadProgressBar);
            status = itemView.findViewById(R.id.indratech_downloadProgressText);
            itemView.getViewTreeObserver().addOnGlobalLayoutListener(this);
            adjustedlayout = false;
            adjustedlayout = false;
            itemView.findViewById(R.id.indratech_download_progress_menu).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    final PopupMenu popup = new PopupMenu(getActivity().getApplicationContext(), view);
                    popup.getMenuInflater().inflate(R.menu.indratech_download_progress_menu, popup.getMenu());
